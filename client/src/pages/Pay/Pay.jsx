...
const Pay = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-6">
      <div className="w-full max-w-lg p-6 bg-white bg-opacity-10 backdrop-blur-lg shadow-2xl rounded-2xl">
        {/* Header */}
        <h2 className="text-center text-3xl font-extrabold text-white">
          {t("selectPaymentMethod")}
        </h2>
        <p className="text-center text-gray-300 mt-2">{t("securePayment")}</p>

        {/* African Payment - Paystack */}
        <div
          onClick={() => handlePayment("paystack")}
          className="mt-6 cursor-pointer p-5 rounded-xl flex items-center justify-between bg-white bg-opacity-20 backdrop-blur-md shadow-lg hover:shadow-2xl hover:bg-opacity-30 transition-all duration-300"
        >
        ...
        {/* <div
          ...
          className="mt-4 cursor-pointer p-5 rounded-xl flex items-center justify-between bg-white bg-opacity-20 backdrop-blur-md shadow-lg hover:shadow-2xl hover:bg-opacity-30 transition-all duration-300"
        >
          <div className="flex items-center gap-3">
            <img
