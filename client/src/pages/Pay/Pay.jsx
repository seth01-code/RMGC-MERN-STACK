...
import Flutterwave from "../../../assets/images/flutterwave-logo-removebg-preview.png"; // Payment icons
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-4 sm:p-6">
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl p-6 bg-white bg-opacity-10 backdrop-blur-lg shadow-2xl rounded-2xl">
        ...
        {/* African Payment - Paystack (Naira & USD Only) */}
        <div className="mt-6">
          ...
          <div
            ...
            className="cursor-pointer p-4 sm:p-5 rounded-xl flex flex-col sm:flex-row items-center justify-between bg-white bg-opacity-20 backdrop-blur-md shadow-lg hover:shadow-2xl hover:bg-opacity-30 transition-all duration-300"
          >
        ...
        {/* International Payment - Flutterwave (Local & International Transactions) */}
        <div className="mt-6">
          <p className="text-white text-sm sm:text-base font-medium mb-2">
            Pay with Flutterwave (Local & International Transactions)
          </p>
          <div
