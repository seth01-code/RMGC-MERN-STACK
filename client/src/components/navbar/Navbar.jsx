      ...
      <div className="container mx-auto flex justify-between items-center py-5 max-w-[1400px]">
        ...
        <div className="flex items-center gap-6 font-medium">
          ...
          >
            ...
            {languageOpen && (
              <div className="absolute top-12 right-0 p-5 bg-gradient-to-r from-[#000000] to-[#130F40] rounded-lg shadow-lg border flex flex-col gap-4 text-white w-[70px] transition-all ease-in-out">
                <button
